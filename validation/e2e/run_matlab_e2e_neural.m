% E2E MATLAB pipeline on e2e_cielab_neural.off (neural-bounded CIELAB gamut).
...
Mm = MeshClass('e2e_cielab_neural');
...
elapsed = toc;
fprintf('MATLAB neural-mesh all-pairs time: %.2fs\n', elapsed);

out = fullfile(this_dir, 'matlab_max_indices_neural.csv');
