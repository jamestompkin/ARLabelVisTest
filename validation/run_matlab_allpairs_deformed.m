% All-pairs RGD on the deformed icosphere at alpha_hat = 0.25.
% Mirror of demo.m for non-symmetric mesh validation.
...
Mm = MeshClass('deformed_ico_sub4');
...
out = fullfile(this_dir, 'matlab_allpairs_deformed_alpha_p25.csv');
